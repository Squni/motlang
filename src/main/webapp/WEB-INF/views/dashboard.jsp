                                    ...
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle"
                                             src='<c:url value="/resources/dashboard/images/avatars/1.jpg"/>' alt="">
                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                           ...
                           <div><%-- <c:out value="Welcome back ${currentUser.name}">--%>
                                <div class="page-title-subheading">Today is DATE and you have NUMBER planned lessons.
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-card mb-3 card">
                            <div class="card-header">Avtive now
                                <div class="btn-actions-pane-right">
                                    <div role="group" class="btn-group-sm btn-group">
                                        <button class="active btn btn-focus">Top rating</button>
                                                    ...
                                                    <div class="widget-content-left mr-3">
                                                        <div class="widget-content-left">
                                                            <img width="40" class="rounded-circle"
                                                                 src='<c:url value="/resources/dashboard/images/avatars/4.jpg"/>'
                                                                 alt="">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left mr-3">
                                                        <div class="widget-content-left">
                                                            <img width="40" class="rounded-circle"
                                                                 src='<c:url value="/resources/dashboard/images/avatars/3.jpg"/>'
                                                                 alt="">
                                                        </div>
                                                    </div>
                                                    <div class="widget-content-left flex2">
                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left mr-3">
                                                        <div class="widget-content-left">
                                                            <img width="40" class="rounded-circle"
                                                                 src='<c:url value="/resources/dashboard/images/avatars/2.jpg"/>'
                                                                 alt="">
                                                        </div>
                                                    </div>
                                                    <div class="widget-content-left flex2">
                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left mr-3">
                                                        <div class="widget-content-left">
                                                            <img width="40" class="rounded-circle"
                                                                 src='<c:url value="/resources/dashboard/images/avatars/1.jpg"/>'
                                                                 alt=""></div>
                                                    </div>
                                                    <div class="widget-content-left flex2">
